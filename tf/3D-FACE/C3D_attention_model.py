...
class C3D_Running:
    def __init__(self):
        ...
        self.gray_encoder.encoder_channel_num = [64,          16]
        ...
        self.root_path = '/home/room304/TB/TB/TensorFlow_Saver/ANORMLY/Attention_test2/'
    ...
    def build_model_adn_loss_opt(self):
        ...
        with tf.device('/cpu:0'):
            ...
            with tf.control_dependencies(update_ops):
                ...
                autoencoder_opt = tf.train.RMSPropOptimizer(learning_rate=1e-4)
...
run_model.train_c3d(100000, restore_tags=True)
