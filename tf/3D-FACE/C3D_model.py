...
from TF_MODEL_Utils.C3D_Depart import C3D as c3d_model
...
class C3D_Running:
    def __init__(self):
        ...
        self.optical_c3d_model.encoder_channel_num = [8,        32,         128]
        self.optical_c3d_model.encoder_stride_num = [[2, 2, 2],[2, 2, 2],[2, 2, 2]]
        self.optical_c3d_model.decoder_channel_num = [32,        8,      self.optical_c3d_model.input_channel]
        self.optical_c3d_model.decoder_stride_num = [[2, 2, 2],[2, 2, 2],[2, 2, 2]]

        self.gray_c3d_model = c3d_model(input_channel=1,model_scope_name='gray_test')
        self.gray_c3d_model.encoder_channel_num = [4,       16,          64]
        self.gray_c3d_model.encoder_stride_num = [[2, 2, 2],[2, 2, 2],[2, 2, 2]]
        self.gray_c3d_model.decoder_channel_num = [64,       32,          self.gray_c3d_model.input_channel]
        self.gray_c3d_model.decoder_stride_num = [[2, 2, 2],[2, 2, 2],[2, 2, 2]]
        ...
        self.optical_save_path = '/media/room304/TB/TensorFlow_Saver/ANORMLY/MID_LR_X3_VN4/MODEL_OPTICAL/'
    ...
    def test_ucsd_dataset_model(self):
        ...
        with tf.Session(config=tf.ConfigProto(gpu_options=gpu_options)) as sess:
            ...
            full_test_dataset = sequence_dataset_sequence()
    ...
    def test_shanghai_dataset_model(self):
        ...
        with tf.Session(config=tf.ConfigProto(gpu_options=gpu_options)) as sess:
            ...
            full_test_dataset = sequence_shanghai_dataset_sequence()
            while (full_test_dataset.continue_tags) :
            # for idx in range(1):
