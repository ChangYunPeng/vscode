...
class C3D_Running:
    def __init__(self):
        ...
        self.root_path = '/home/room304/TB/TB/TensorFlow_Saver/ANORMLY/Attention_test_not_interval_only_optical/'
            ...
            with tf.device('/gpu:%d' % self.selected_gpu_num):
                with tf.name_scope('GPU%d' % self.selected_gpu_num) as scope:
                    ...
                    with tf.name_scope('train_loss'):
                        ...
                        self.total_loss = self.optical_loss* self.optical_flow_loss_ratio + self.mid_stage_loss*self.mid_stage_loss_ratio
                    update_ops = tf.get_collection(tf.GraphKeys.UPDATE_OPS)
                    # print(update_ops)
