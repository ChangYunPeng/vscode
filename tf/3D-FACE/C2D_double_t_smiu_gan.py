...
from C3D_MODEL import C3D_ENCODER,C3D_DECODER,C2D_ENCODER,C2D_DECODER,Attention_Model, Attention_Model_Xt, Attention_Convert_Model, C3D_Test_ENCODER, C2D_Test_ENCODER, Attention_Test_Model,C3D_Test_DECODER
...
class C3D_Running:
    def __init__(self):
        ...
        self.gray_encoder.encoder_channel_num = [64,   8]
        ...
        self.gray_decoder = C3D_Test_DECODER(input_channel=1,model_scope_name='gray_decoder', bn_tag = False)
        self.gray_decoder.decoder_channel_num = [64,   1]
        self.gray_decoder.decoder_stride_num = [[ 1, 1],[ 1, 1] ]
        self.gray_decoder.decoder_kernel_size = [[ 3, 3],[ 1, 1]]
        ...
        self.root_path = '/home/room304/TB/TB/TensorFlow_Saver/ANORMLY/Split_C2D/'
            ...
            with tf.device('/gpu:%d' % self.selected_gpu_num):
                with tf.name_scope('GPU%d' % self.selected_gpu_num) as scope:
                    ...
                    with tf.name_scope('train_loss'):
                        ...
                        self.total_loss =  -self.gray_loss_ratio * self.gray_loss -self.att_loss + self.extra_loss_ratio *(att1_extra_loss + att2_extra_loss)
    ...
    def train_c3d(self,max_iteration = 100000 , restore_tags = True, trainable_whole=True, trainable_mid = True, ):
        ...
        summaries_dir = self.summaries_dir + 'slice_temporal_to_compare_model%d.CPTK' % time.time()
...
# run_model.train_c3d(100000, restore_tags=True, trainable_whole=True, trainable_mid = True)
